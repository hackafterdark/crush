...
func TestSanitizeJSONInputRealToolCall(t *testing.T) {
	...
	input := `{"command": "cd F:/hackafterdark/crush && git log --oneline -20 && echo --- && git diff HEAD~1 --stat", "working_dir": "F:/hackafterdark/crush", "description": "Check recent commits and diff stat", "run_in_background": false, "auto_background_after": 60}
</cwd>

<cwd>F:/hackafterdark/crush</cwd>`
	expected := `{"command": "cd F:/hackafterdark/crush && git log --oneline -20 && echo --- && git diff HEAD~1 --stat", "working_dir": "F:/hackafterdark/crush", "description": "Check recent commits and diff stat", "run_in_background": false, "auto_background_after": 60}`
